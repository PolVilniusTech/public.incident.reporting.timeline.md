...
From such incidents there are possible to learn a lot. I.e.:
* In normal environment of the Equivalent Exchange Bank Instritutions and Gov Regulations it would be impossible to use locally selld devices in the E.U. Banking system.
