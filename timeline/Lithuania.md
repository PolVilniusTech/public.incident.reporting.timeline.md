...
*  Social Media Networks [x.com](https://x.com/v_of_europe) and [facebook.com](https://www.facebook.com/rianru) comply with the official Ban. Origin of limited checks completed thanks to original & official information, which could be found in here [europa.eu](https://www.consilium.europa.eu/en/policies/sanctions-against-russia/timeline-sanctions-against-russia/). Banning Media does not solve issues or cause of problem(s).
