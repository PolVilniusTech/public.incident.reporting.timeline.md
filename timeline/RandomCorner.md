...
* For traveling to an Belarus, a Russia, an Iran, an Ukraine are necessary to get International Driving License [registra.lt](https://www.regitra.lt/tarptautiniu-vairuotojo-pazymejimu-isdavimas), which last maximum up to 3 (three) Years for Members of Vienna Convention and no more than 1 (single) Year for Members of Geneva Convention.
```
