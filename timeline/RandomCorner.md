...
* High-tech AI companies and those who control them must include high risk of plausibilty for deepfake and scamming of regular people when knowledge of their employees, relatives and so on could be used "against them" and to control those entities, and people. Who has capability to build deepfake is a risk subject (ISO/IEC 27005:2022 - risk source). Affected entity and person — risk object, e.g. [-](https://www.tv3.lt/naujiena/lietuva/sukciai-pasinaudojo-ir-ekonomisto-nerijaus-maciulio-atvaizdu-ir-balsu-nebuvo-malonus-jausmas-n1436874).
```
