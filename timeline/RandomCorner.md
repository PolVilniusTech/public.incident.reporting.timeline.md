...
* When scientists who use LLMs regularly are still in the minority [nature.com](https://www.nature.com/articles/d41586-023-03144-w) a following check [-](https://github.com/PolVilniusTech/public.incident.reporting.timeline.md/blob/main/RandomCorner/Images/Copilot%202024-06-19%20CSIRT%20and%20CRRT.PNG) show that generated content and attached references to this content are all correct.
```
...
* Sample of fight with IoT by blocking telecommunication mean related functionality [LRT.lt](https://www.lrt.lt/naujienos/mokslas-ir-it/11/2704270/rusija-uzsienio-operatoriams-is-dalies-blokavo-tarptinklini-rysi).
```
...
The Article [LRT.lt](https://www.lrt.lt/naujienos/mokslas-ir-it/11/2717255/savaite-moksle-windows-10-eros-pabaiga-nauji-ziogai-lietuvoje-masinis-koralu-nykimas) are including an event list as a Week of Science. It communicate out the awareness, that the Windows 10th OS Version has reached it's end of life.
```
...
4. Researcher's Desktop - 10-25% (Linux); 40-60% (Windows); 20-35% (macOS).
```
