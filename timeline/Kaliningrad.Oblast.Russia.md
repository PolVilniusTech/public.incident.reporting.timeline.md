...
From such incidents there are possible to learn a lot. I.e.:
*    If Interpol does not cope in two weeks to stop Invasion Side which were done without provided strong evidence why they are doing it, then such organisation is Rusty in World-Wide Problems related to the Armies and Special Forces. Comparision of strong evidence could be found disparity between doing the Math on people lives and etc.
