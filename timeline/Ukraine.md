...
According all of these News Services [LRT.lt, BBC News Русская служба, Deutsche Welle, Радио «Cвобода»](https://www.lrt.lt/ru/novosti/17/1728612/voina-v-ukraine-vozroslo-chislo-zhertv-raketnogo-udara-po-trts-v-kremenchuge) attack are made as appropriate because there was "ангарам с оружием и боеприпасами".

```

```
##### R esults 
Loss of "ангар с оружием и боеприпасами".
```
...
From such incidents there are possible to learn a lot. I.e.:
* There should be providen possibility to prove the claims with their and local and international entities for Offensive, Crime, Forensic Investigation.
* According this News Media [LRT.lt](https://www.lrt.lt/mediateka/irasas/2000222076/zinios-ukraina-nori-kad-prekybos-centro-subombardavimo-byla-svarstytu-hagos-teismas) there already pille of Documents to pass it to the War Tribunal. According this News Media [LRT.lt](https://www.lrt.lt/mediateka/irasas/2000221971/zinios-del-vakar-susprogdinto-prekybos-centro-zelenskis-kviecia-susaukti-skubu-jt-saugumo-tarybos-posedi) there shown the need for participation in United Nations Security Council. Currently their Boss is from Tiny Country and it does not seem that anything could be changed in such Organisation.
* Organization for Security and Co-operation in Europe (OSCE) has observer status at the United Nations, but it should care more for the Security of the Europe. Does Agressor and the Victim are in the same Europe or no? Does OSCE are taking in account the Private Millitry Units from all Sides? The U.S.S.R-Russia-Russian Federation (following - Axis) belongs to the OSCE, but there are Helsinki Act which are white-to-black and black-to-white written that Sovereign and where these entities by joining should be accountable for full Integrity of the Borders for those Countries in the Europe. In Contrast, OSCE should be Integral sample of the NATO in the Europe Only.
* Axis and Isreal both are good at Building Homes in Abroad Lands, similarities with Palestine. Usually when You purchase the Flat, there would be e.Services and Services already in Place, but now the new Owner has to pay the bills. The Problem, that You should newer get e.Service and Service, if You don't have the Right Agreement, so all the e.Services and Services should be blocked until the Agreement are written and signed with regular signature and (or) qualified signature between the new Flat Owner and e.Service-Service provider. The Idea. What would happen when some Entity-Organisation are changing their name? Does the Citizens have to get new Identity Cards? but what if new Owner of the Entity-Organisation are not meeting the International Law which were signed by pre-decessor Owner?
* Aligning phrase of "Human Rights" with phrases of "Rights of the People" and in International level "Common Rights of the People" would be Wise, but the question: does these People have right to choose their Position?
* Other Problem is when the Church are bound with the Country and starts aligning with the events, which does not belong to the "Rights of the People", the People have the chance to choose and show their Position, but does there are pretty much the same with the Governments? who are building Republics and Democratic Countries.
* Here are other Dual-Face of the Organisation for which Ukraine wish to Join [-](https://www.lrt.lt/naujienos/eismas/7/1724507/draudimas-prekiauti-iprastais-automobiliais-tarsi-pandoros-skrynia-tiek-nauji-elektromobiliai-tiek-naudoti-dyzeliai-gali-tapti-sunkiai-iperkami). From Year of 2035 no new Vehicles with Combustion Engines and Only going into Renewables and so. Does this only shows that the Axis would get more Income from the Energy Export with their Nuclear Power Plants all around the World? In other Side, probably there only Funny Videos around and only one Tycoon who has such Tech in the Market. 
* Threats from Various Markets is like one Economic System are powered with Millitaty eq like Guns, Rockets and Nuclear Rockets, but does everyone align that Nuclear Rockets should be never used? Then what about Nuclear Power Plant(s)? In other sample of Economic System which are powered with Energy Production, Import and Export, but does Coal Power already is Threat to the Climate Change? which is first option for many Countries to Opt-out, like in other words, the Axis has Opt-out from all "Human Rights" Organisations which exists in this Planet Internally and Externally.  
```
